      ...
      <div className="max-w-[1000px] mx-auto px-6 md:px-12 mt-24">
         <section>
             <div className="flex flex-col md:flex-row items-baseline justify-between mb-12 border-b border-gray-200 pb-6">
                <h2 className="text-3xl font-light tracking-tight text-gray-900">Mülkünüzü Bize Emanet Edin</h2>
                <span className="text-sm uppercase tracking-widest text-gray-400 mt-2 md:mt-0">Sat / Kirala</span>
             </div>
