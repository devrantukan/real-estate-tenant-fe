...
export default function HomepageRentalList({
  ...
  // Force refresh
  const [selected, setSelected] = React.useState("kiralik-konut");
  return (
        ...
        >
          <Tab key="kiralik-konut" title="Konut">
            <div className="grid grid-cols-1 gap-y-4">
               ...
               <div className="mt-4">
                 <Link href={`/konut/kiralik/`} className="w-full block">
                   <Button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900" variant="flat">
                     <span className="font-medium flex flex-row items-center justify-center">
                       <span className="mr-2">Tüm Kiralık Konut İlanlarını Gör</span>
          ...
          <Tab key="kiralik-ticari" title="Ticari">
            <div className="grid grid-cols-1 gap-y-4">
               ...
               <div className="mt-4">
                 <Link href={`/ticari/kiralik/`} className="w-full block">
                   <Button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900" variant="flat">
                     <span className="font-medium flex flex-row items-center justify-center">
                       <span className="mr-2">Tüm Kiralık Ticari İlanlarını Gör</span>
                       <ArrowCircleRight size={20} />
                     </span>
                   </Button>
                 </Link>
          ...
          <Tab key="kiralik-arsa-arazi" title="Arsa Arazi">
            <div className="grid grid-cols-1 gap-y-4">
               ...
               <div className="mt-4">
                 <Link href={`/arsa-arazi/kiralik/`} className="w-full block">
                   <Button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900" variant="flat">
                     <span className="font-medium flex flex-row items-center justify-center">
                       <span className="mr-2">Tüm Kiralık Arsa/Arazi İlanlarını Gör</span>
                       <ArrowCircleRight size={20} />
                     </span>
                   </Button>
                 </Link>
